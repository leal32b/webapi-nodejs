...
import { type MiddlewareRequest, type Middleware } from '@/core/1.application/middleware/middleware'
import { type AppResponse } from '@/core/2.presentation/base/controller'
import { InvalidTokenError } from '@/core/2.presentation/errors/invalid-token-error'
import { MissingAuthError } from '@/core/2.presentation/errors/missing-auth-error'
import { MissingTokenError } from '@/core/2.presentation/errors/missing-token-error'
